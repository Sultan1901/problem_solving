...
Write a function named containsW that takes in a string. This function should use a
 regular expression pattern to return true if the string contains the letter 'w' in lower case or false if it does not. 
...
const containsWorld = (input) => {
  if (input.includes("world")) return true;
  else return false;
};
...
const isCapitalized = (str) => {
  return str.includes(["QWERTYUIOPLKJHGFDSAZXCVBNM"]);
};
